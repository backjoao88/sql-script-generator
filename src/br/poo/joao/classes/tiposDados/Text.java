...
/**
 * 
 * Classe responsável por representar o tipo de dado Text. Extende de DadoComUmParametro e 
...
public class Text extends DadoComUmParametro implements IDadoComUmParametro {
	
	public Text() {
		this.setNome("sTEXT");
	}
	
	public Text comOParametroUm(int tamanho) {
