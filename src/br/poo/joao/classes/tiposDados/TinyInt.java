...
/**
 * 
 * Classe responsável por representar o tipo de dado TinyInt. Extende de DadoComUmParametro e 
...
public class TinyInt extends DadoComUmParametro implements IDadoComUmParametro{
	
	public TinyInt() {
		this.setNome("TINY INT");
	}
	
	public TinyInt comOParametroUm(int tamanho) {
