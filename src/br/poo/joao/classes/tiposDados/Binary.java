 ...
 * 
 * 
 * Classe responsável por representar o tipo de dado Binary. Extende de DadoComUmParametro e 
...
public class Binary extends DadoComUmParametro implements IDadoComUmParametro{
	
	public Binary() {
		this.setNome("BINARY");
	}
	
	public Binary comOParametroUm(int tamanho) {
