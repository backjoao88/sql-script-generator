 ...
 * 
 * 
 * Classe responsável por representar o tipo de dado Bit. Extende de DadoComUmParametro e 
...
public class Bit extends DadoComUmParametro implements IDadoComUmParametro{
	
	public Bit() {
		this.setNome("BIT");
	}
	
	public Bit comOParametroUm(int tamanho) {
