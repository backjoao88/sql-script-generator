...
/**
 * 
 * Classe responsável por representar o tipo de dado VarBinary. Extende de DadoComUmParametro e 
...
public class VarBinary extends DadoComUmParametro implements IDadoComUmParametro {
	
	public VarBinary() {
		this.setNome("VARBINARY");
	}
	
	public VarBinary comOParametroUm(int tamanho) {
