...
/**
 * 
 * Classe responsável por representar o tipo de dado TimeStamp. Extende de DadoComUmParametro e 
...
public class TimeStamp extends DadoComUmParametro implements IDadoComUmParametro, IDadoSemParametro{
	
	public TimeStamp() {
		this.setNome("TIME STAMP");
	}
	
	public TimeStamp comOParametroUm(int tamanho) {
