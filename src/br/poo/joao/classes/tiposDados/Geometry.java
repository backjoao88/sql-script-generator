...
/**
 * 
 * Classe responsável por representar o tipo de dado Geometry. Extende de Dado e 
...
public class Geometry extends Dado implements IDadoSemParametro {
	
	public Geometry() {
		this.setNome("GEOMETRY");
	}
