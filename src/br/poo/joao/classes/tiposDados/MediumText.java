...
/**
 * 
 * Classe responsável por representar o tipo de dado MediumText. Extende de Dado e 
...
public class MediumText extends Dado implements IDadoSemParametro {
	
	public MediumText() {
		this.setNome("MEDIUM TEXT");
	}
