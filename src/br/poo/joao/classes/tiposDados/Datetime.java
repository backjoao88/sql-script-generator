...
/**
 * 
 * Classe responsável por representar o tipo de dado Datetime. Extende de DadoComUmParametro e 
...
public class Datetime extends DadoComUmParametro implements IDadoComUmParametro{
	
	public Datetime() {
		this.setNome("DATE TIME");
	}
	
	public Datetime comOParametroUm(int tamanho) {
